...
const ProjectDetail = () => {
    ...
    if (!project) {
        return <div className="text-center text-slate-500 mt-10">Project not found</div>;
    }
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-slate-50 rounded-xl shadow-sm border border-slate-300 overflow-hidden">
                <div className="p-6 md:p-8">
                    ...
                    <div className="aspect-video rounded-lg overflow-hidden shadow-lg bg-black mb-8">
                        <iframe
                            width="100%"
                            height="100%"
                    ...
                    <div className="flex gap-4 border-t border-slate-200 pt-6">
                        <a href={project.demoUrl} target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-slate-800 text-white rounded-lg font-semibold hover:bg-slate-700 transition-all shadow-md hover:shadow-lg flex items-center gap-2">
                            <span>Live Demo</span>
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                        </a>
                        <a href={project.sourceUrl} target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-white text-slate-700 border border-slate-300 rounded-lg font-semibold hover:bg-slate-50 transition-all shadow-sm hover:shadow-md flex items-center gap-2">

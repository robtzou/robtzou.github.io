...
const Sidebar = () => {
    ...
    return (
        <aside className="w-full md:w-1/4 lg:w-1/3 bg-slate-800 text-slate-200 md:h-screen md:sticky md:top-0 flex flex-col border-r border-slate-700 transition-all duration-300 ease-in-out z-50">
            {/* Mobile Header */}
            <div className="md:hidden flex items-center justify-between p-4 border-b border-slate-700 bg-slate-800 sticky top-0 z-50">
                <div className="flex items-center gap-3">
                    ...
                    />
                    <span className="font-bold text-slate-100">Robert Tzou</span>
                </div>
                <button
            ...
            {/* Main Content */}
            <div className={`${isOpen ? 'block' : 'hidden'} md:block p-6 overflow-y-auto flex-1`}>
                <div className="mb-6">
